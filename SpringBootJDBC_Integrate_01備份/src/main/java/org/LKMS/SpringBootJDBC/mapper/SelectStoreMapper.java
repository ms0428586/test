...
public class SelectStoreMapper implements RowMapper<StoreInfo> {
		public static final String BASE_SQL
		="SELECT ST.STORE_CATEGORYS,ST.STORE_NAMES,ST.STORE_ADDRESS,ST.STORE_PHONE,ST.STORE_HOURS FROM store_test01 ST WHERE ST.STORE_CATEGORYS LIKE'%?%'";
...
//			String storeId = rs.getString("STORE_ID");
	        ...
	        return new StoreInfo( storeCategory, storeName, storeAddress, storePhone, storeHours);
