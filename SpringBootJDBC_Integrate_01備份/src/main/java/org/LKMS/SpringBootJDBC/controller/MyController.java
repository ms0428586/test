...
import org.LKMS.SpringBootJDBC.dao.SearchStoreDAO;
...
public class MyController {
	...
	@Autowired
	private SearchStoreDAO searchstoreDAO;
	
	@Autowired
    private MemberDAO memberDAO;
//	@Autowired
//    private SearchStoreForm searchStoreForm;
...
//	處理送來的表單資料
	...
	public String viewChoosestore( Model model ,@ModelAttribute("searchStoreFrom") SearchStoreForm searchStoreFrom) {
//		MENU
//		String getCategory = searchStoreForm.getSearchStore();
		System.out.println(searchStoreFrom.getSearchStore()+"------------");
		List<StoreInfo> list = storeDAO.getStore(searchStoreFrom.getSearchStore());
		model.addAttribute("storeInfos", list);
		
//		SearchStoreForm searchStoreForm = new SearchStoreForm("火鍋");
		model.addAttribute("searchStoreForm", searchStoreFrom); 
	...
	public String processViewChoosestore(Model model, @ModelAttribute("searchStoreFrom") SearchStoreForm searchStoreFrom) {
		SearchStoreForm searchStoreForm = new SearchStoreForm("SearchStore");
		model.addAttribute("searchStoreForm", searchStoreForm); 
		
		
//		List<StoreInfo> list = searchstoreDAO.getStore();
//		model.addAttribute("storeInfos", list);
////		
//		SearchStoreForm searchStoreForm = new SearchStoreForm("SearchStore");
//		model.addAttribute("searchStoreForm", searchStoreForm); 
