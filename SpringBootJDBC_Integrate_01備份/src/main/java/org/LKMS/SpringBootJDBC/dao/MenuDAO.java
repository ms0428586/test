...
public class MenuDAO extends JdbcDaoSupport {
	...
	public void AddMenu(String newId, String newproductName, String newproductSize, double newproductPrice,
		...
		this.getJdbcTemplate().update(sqlInsert, newId, newproductName, newproductSize, newproductPrice,
