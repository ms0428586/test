...
public class MenuDAO extends JdbcDaoSupport {
	...
	public void AddMenu(Long newId,String newproductCode ,String newproductName,String newproductSize,
			double newproductPrice,String newproductCategory,String newproductDescription) {
		System.out.println("SQL-----------");
		String sqlInsert ="INSERT INTO menu(ID,PRODUCTS_CODE,PRODUCTS_NAME, PRODUCTS_SIZE,PRODUCTS_PRICE,PRODUCTS_CATEGORY, PRODUCTS_DESCRIPTION	) VALUES (?,?,?,?,?,?,?)";
		this.getJdbcTemplate().update(sqlInsert,newId,newproductCode,newproductName,newproductSize,newproductPrice,newproductCategory,newproductDescription);
		System.out.println("SQL-----------");
	}
