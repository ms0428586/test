...
import org.LKMS.SpringBootJDBC.Entity.RestaurantPhotoList;
...
public class RestaurantDAO {
	...
	public List<RestaurantInfo> SearchRestaurant(String searchRestaurant) {
		...
		String sql = "Select new " + RestaurantInfo.class.getName()
				+ "(R.restaurantId,R.restaurantCategory,R.restaurantName,R.restaurantAddress,"
				+ "R.restaurantPrice,R.restaurantPhone,R.businessHours,R.restaurantWeb,R.restaurantImg,R.restaurantMap,R.restaurantCity) "
				+ " from " + Restaurant.class.getName() + " R WHERE restaurantCategory LIKE '%" + searchRestaurant
				+ "%'" + "OR restaurantName LIKE '%" + searchRestaurant + "%'" + "OR restaurantAddress LIKE '%"
				+ searchRestaurant + "%'" + "OR restaurantCity LIKE '%" + searchRestaurant + "%'";
	...
	public List<PhotoListInfo> getpohtoListInfo(Long id) {

		String sql = "Select new " + PhotoListInfo.class.getName() + "(RP.RestaurantId,RP.RestaurantPhoto) " + " from "
				+ RestaurantPhotoList.class.getName() + " RP WHERE RestaurantId=" + id;

		Query query = entityManager.createQuery(sql, PhotoListInfo.class);

		return query.getResultList();
	}

	public List<RestaurantInfo> getrecommend(long id) {
